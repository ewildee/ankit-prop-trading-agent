...
- Local gate passed: `bun run lint:fix`; focused Trader/Judge/runner/replay specs 25/0; `bun test` 624/0; `bun run typecheck`; persona numeric grep/diff check clean.
